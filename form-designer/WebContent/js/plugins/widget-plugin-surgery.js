...
function showSurgeryPluginInitConfigDialog() {
	...
	var html = ['<div class="dialog" style="width:300px;height:180px;">',
                ...
                '<tr><td style="width:20%;">显示方向：</td>',
                '<td style="width:80%;" valign="top"><select name="direction" style="width:100%"><option value="horizontal" selected>横向</option><option value="vertical">垂直</option></select></td></tr>',
