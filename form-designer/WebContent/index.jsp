...
<%@page import="com.neusoft.hit.emr.fd.util.*"%>
...
<body style="padding:0;margin:0;font-family:SimSun;">
	...
	<!-- 弹出框遮罩层 -->
	<div class="mask-layer-tpl" style="position:fixed;top:0;right:0;bottom:0;left:0;background:rgba(0,0,0,0.3);z-index:190;display:none;">
		...
		<form style="padding:15px;">
			<table style="width:100%;">
				<tr>
					<td>内容</td>
					<td>
						<textarea name="text-val" class="config-item" required="true" style="width:100%;height:100px;"></textarea>
					</td>
				</tr>
				<tr>
					<td colspan="3" align="center">
		...
		<form style="padding:15px;">
			<table style="width:100%;">
				<tr>
					<td>表头(thead)行数</td>
					<td>
						<input disabled name="thead-row-num" class="config-item" type="number" required="true" style="width:100px;"/>
					</td>
					<td>
				...
				<tr>
					<td>表体(tbody)行数</td>
					<td colspan="2">
						<input name="tbody-row-num" class="config-item" type="number" style="width:100px;" min="1" required="true"/>
					</td>
				</tr>
				<tr>
					<td>表格列数</td>
					<td colspan="2">
						<input name="table-col-num" class="config-item" type="number" style="width:100px;" min="1" required="true"/>
					</td>
				</tr>
				<tr>
					<td>是否为数据行</td>
